...
public class NotificationServiceTest {
    ...
    public void testCreateNotification() throws IOException {
        ...
        Notification notification = Notification.builder()
            ...
            .build();
        String message = "sender 님이 user 님에게 대화를 요청합니다.";
        ...
        // when
        notificationService.create(form, message);
    ...
    public void testUnreadNotifications() {
        ...
        Notification notification1 = Notification.builder()
            ...
            .user(user)
            .args(2L)
            .content(ContentType.REFUSE_REQUEST_CHAT)
            .build();
        Notification notification2 = Notification.builder()
            .id(15L)
            .user(user)
            .args(3L)
            .content(ContentType.REQUEST_CHAT)
            .build();
